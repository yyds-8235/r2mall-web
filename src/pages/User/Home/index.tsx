    ...
    <div className="home-container">
      ...
      <Card className="carousel-card">
        <Carousel autoplay dots className="carousel-container">
          <div>
            <img src={'/src/assets/banner1.png'} alt="banner0" className="carousel-image" />
          </div>
          <div>
            <img src={'/src/assets/banner0.png'} alt="banner2" className="carousel-image" />
          </div>
          <div>
            <img src={'/src/assets/banner2.png'} alt="banner3" className="carousel-image" />
          </div>
        </Carousel>
      </Card>
